...
class CreateToastsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('toasts', function (Blueprint $table) {
            ...
            $table->foreign("own_order_id")->references("id")->on("own_orders")->onDelete("cascade")->nullable();
            $table->unsignedBigInteger("maquila_order_id");
            $table->foreign("maquila_order_id")->references("id")->on("maquila_orders")->onDelete("cascade")->nullable();
